                                                                        ...
                                                                        {inventoryData.map((prod, idx) => {
                                                                            ...
                                                                            if (imgSrc) {
                                                                                if (typeof imgSrc === 'string') {
                                                                                    if (imgSrc.includes('=')) {
                                                                                        ...
                                                                                        try {
                                                                                            ...
                                                                                            try {
                                                                                                const parsed = JSON.parse(JSON.parse(imgSrc));
                                                                                                imgSrc = parsed;
                                                                                            } catch (e2) {}
                                                                                        }
                                                                                    }
                                                                                ...
                                                                                if (typeof imgSrc === 'string' && (imgSrc.startsWith('/uploads/') || imgSrc.startsWith('uploads/'))) {
                                                                                    ...
                                                                                    const baseUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:6043/api';
                                                                                    imgSrc = baseUrl.replace('/api', '') + imgSrc;
                                                                                }
                                                                                
                                                                                // If it's still not a full URL or a data URI by this point, it's likely broken.
                                                                            }
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div style={{display:'none'}} className="text-[8px] text-red-500 w-12 break-all overflow-hidden max-h-12 border border-red-200 p-0.5 rounded">{imgSrc}</div>
